...
/**
 * Local Codex panels can emit a burst of weak thread notifications immediately
 * after a WeChat reply. Suppress only the user-facing notice in that window;
 * the adapter still updates its internal shared-thread state.
 */
